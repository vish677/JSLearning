let arrayOfNumber = [0, 2, 4, 6, 7, 8];
console.log(arrayOfNumber);
console.table(arrayOfNumber);
const totalArrayElement = arrayOfNumber.length;
console.log(`Total elemts available in array is ${totalArrayElement}`);
...
console.log("============================");
var arrayOfNumberss = [ 10, 20, 25, 15, 40, 45];
console.log("==== splice(startIndex) === ");
const splicedArray = arrayOfNumberss.splice(3);
console.log(`Removed elements from array is: ${splicedArray}` );
console.log(arrayOfNumberss);

var arrayOfNumbersss = [ 10, 20, 25, 15, 40, 45];
console.log("==== splice(startIndex, deleteCount) === ");
const splicedArrayWithDeleteCount = arrayOfNumbersss.splice(2, 2);
console.log(`Removed elements using deleteCount is: ${splicedArrayWithDeleteCount}` );
console.log(arrayOfNumbersss);



var array = [10,20, 25, 15, 40, 45];
const deleteword = array.splice(1,2);
console.log(`After removing 20,25: ${deleteword}`);
